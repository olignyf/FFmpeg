...
//       Created : 12.Apr.2015 (wide-string version)
//
//  Description:
...
//  treeItem_T * iterator = NULL;
   ...
   int inserted = 0;
    ...
    if ( genericTree->should_always_be_0xAFAF7878 != (int)0xAFAF7878 )
    {
    ...
    if ( genericTree->max_name_length > 0 && (int)strLen >= genericTree->max_name_length )
    {
        free(newItem);
