...
#endif
#if C_TOOLBOX_CRYPT == 1
#   include "toolbox-crypt.h"
#endif
...
int C_System2(const char * command, char * loadme, unsigned int loadme_size, int * status, int stderrOnly);
BOOL C_FileTouch(const char * filename);
